...
plt.tight_layout()
plt.savefig('img/optimizers_prediction.png')

plt.figure(num="convergence")
plt.legend(['GD', 'Adagrad', 'Momentum', 'Adam'])
plt.tight_layout()
plt.savefig('img/optimizers_convergence.png')
